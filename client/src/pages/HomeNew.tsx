...
const HomeNew = ({ eventFilters = { competition: true, meeting: true, deadline: true, social: true } }: HomeProps) => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-spin w-8 h-8 border-4 border-[#003366] border-t-transparent rounded-full" aria-label="Loading"/>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex gap-6">
            ...
            <div className="hidden lg:block w-64 flex-shrink-0">
              <Sidebar eventFilters={filters} toggleFilter={toggleFilter} />
              <EventReminders events={events} />
              <ResourcesCard />
            </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                  <DayEventsView 
                    ...
                    eventFilters={filters}
                  />
                  <UpcomingEvents events={events} eventFilters={filters} />
                </div>
              </div>
            </div>
          </div>
